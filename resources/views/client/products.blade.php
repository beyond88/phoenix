            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/2.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/4.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/25.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
                        <h6 class="mb-2 lh-sm line-clamp-3 product-name">RESPAWN 200 Racing Style Gaming Chair, in Gray RSP 200 GRY</h6>
                        </a>
                        <p class="fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="text-body-quaternary fw-semibold ms-1">(8 people rated)</span>
                        </p>
                    </div>
                    <div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/27.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
                        <h6 class="mb-2 lh-sm line-clamp-3 product-name">LEVOIT Humidifiers for Bedroom Large Room 6L Warm and Cool Mist for...</h6>
                        </a>
                        <p class="fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="text-body-quaternary fw-semibold ms-1">(3 people rated)</span>
                        </p>
                    </div>
                    <div>
                        <h3 class="text-body-emphasis">$299.00</h3>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/26.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/18.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
                        ...
                        <p class="fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="text-body-quaternary fw-semibold ms-1">(1 people rated)</span>
                        </p>
                    </div>
                    <div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/17.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/24.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xxl-2">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/20.png') }}" alt="" />
                        </div><a class="stretched-link" href="{{ url('product') }}">
