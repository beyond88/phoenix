...
@section("title", "Product Details | Phoenix")
            ...
            <div class="col-12 col-lg-6">
                ...
                <div>
                    ...
                    <div class="d-flex product-color-variants" data-product-color-variants="data-product-color-variants">
                        <div class="rounded-1 border border-translucent me-2 active" data-variant="Blue" data-products-images='["{{ url("img/products/details/blue_front.png") }}","{{ url("img/products/details/blue_back.png") }}","{{ url("img/products/details/blue_side.png") }}"]'><img src="{{ url('img/products/details/blue_front.png') }}" alt="" width="38" /></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Red" data-products-images='["{{ url("img/products/details/red_front.png") }}","{{ url("img/products/details/red_back.png") }}","{{ url("img/products/details/red_side.png") }}"]'><img src="{{ url('img/products/details/red_front.png') }}" alt="" width="38" /></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Green" data-products-images='["{{ url("img/products/details/green_front.png") }}","{{ url("img/products/details/green_back.png") }}","{{ url("img/products/details/green_side.png") }}"]'><img src="{{ url('img/products/details/green_front.png') }}" alt="" width="38" /></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Purple" data-products-images='["{{ url("img/products/details/purple_front.png") }}","{{ url("img/products/details/purple_back.png") }}","{{ url("img/products/details/purple_side.png") }}"]'><img src="{{ url('img/products/details/purple_front.png') }}" alt="" width="38" /></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Silver" data-products-images='["{{ url("img/products/details/silver_front.png") }}","{{ url("img/products/details/silver_back.png") }}","{{ url("img/products/details/silver_side.png") }}"]'><img src="{{ url('img/products/details/silver_front.png') }}" alt="" width="38" /></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Yellow" data-products-images='["{{ url("img/products/details/yellow_front.png") }}","{{ url("img/products/details/yellow_back.png") }}","{{ url("img/products/details/yellow_side.png") }}"]'><img src="{{ url('img/products/details/yellow_front.png') }}" alt="" width="38" /></div>
                        <div class="rounded-1 border border-translucent me-2" data-variant="Orange" data-products-images='["{{ url("img/products/details/orange_front.png") }}","{{ url("img/products/details/orange_back.png") }}","{{ url("img/products/details/orange_side.png") }}"]'><img src="{{ url('img/products/details/orange_front.png') }}" alt="" width="38" /></div>
                    </div>
                    </div>
            ...
            <div class="col-12 col-lg-7 col-xl-8">
                ...
                <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        ...
                        <div class="modal fade" id="reviewModal" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="modal-content p-4">
                                ...
                                <div class="dz-preview d-flex flex-wrap">
                                    <div class="border border-translucent bg-body-emphasis rounded-3 d-flex flex-center position-relative me-2 mb-2" style="height:80px;width:80px;"><img class="dz-image" src="{{ url('img/products/23.png') }}" alt="..." data-dz-thumbnail><a class="dz-remove text-body-quaternary" href="#!" data-dz-remove><span data-feather="x"></span></a></div>
                                </div>
                                <div class="dz-message text-body-tertiary text-opacity-85 fw-bold fs-9 p-4" data-dz-message>
                                    ...
                                    <button class="btn btn-link p-0">Browse from device </button><br><img class="mt-3 me-2" src="{{ url('img/icons/image-icon.png') }}" width="24" alt="">
                                </div>
                                </div>
                    ...
                    <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                        ...
                        <div class="col-auto"><a href="{{ url('img/e-commerce/review-11.jpg') }}" data-gallery="gallery-0"><img src="{{ url('img/e-commerce/review-11.jpg') }}" alt="" height="164" /></a></div>
                        <div class="col-auto"><a href="{{ url('img/e-commerce/review-12.jpg') }}" data-gallery="gallery-0"><img src="{{ url('img/e-commerce/review-12.jpg') }}" alt="" height="164" /></a></div>
                        <div class="col-auto"><a href="{{ url('img/e-commerce/review-13.jpg') }}" data-gallery="gallery-0"><img src="{{ url('img/e-commerce/review-13.jpg') }}" alt="" height="164" /></a></div>
                        </div>
                    ...
                    <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                        ...
                        <div class="row g-2 mb-2">
                        <div class="col-auto"><a href="{{ url('img/e-commerce/review-14.jpg') }}" data-gallery="gallery-3"><img src="{{ url('img/e-commerce/review-14.jpg') }}" alt="" height="164" /></a></div>
                        <div class="col-auto"><a href="{{ url('img/e-commerce/review-15.jpg') }}" data-gallery="gallery-3"><img src="{{ url('img/e-commerce/review-15.jpg') }}" alt="" height="164" /></a></div>
                        <div class="col-auto"><a href="{{ url('img/e-commerce/review-16.jpg') }}" data-gallery="gallery-3"><img src="{{ url('img/e-commerce/review-16.jpg') }}" alt="" height="164" /></a></div>
                        </div>
                        <div class="hover-actions top-0">
                        <button class="btn btn-sm btn-phoenix-secondary me-2"><span class="fas fa-thumbs-up"></span></button>
                        <button class="btn btn-sm btn-phoenix-secondary me-1"><span class="fas fa-thumbs-down"></span></button>
            ...
            <div class="col-12 col-lg-5 col-xl-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        </div><a href="../../../apps/e-commerce/landing/product-details.html"> <img class="border border-translucent rounded" src="{{ url('img/products/2.png') }}" width="53" alt="" /></a>
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <input class="form-check-input" type="checkbox" checked="checked" />
                        <label class="form-check-label"></label>
                        </div><a href="../../../apps/e-commerce/landing/product-details.html"> <img class="border border-translucent rounded" src="{{ url('img/products/16.png' ) }}" width="53" alt="" /></a>
                    ...
                    <div class="d-flex align-items-center mb-0">
                        ...
                        <label class="form-check-label"></label>
                        </div><a href="../../../apps/e-commerce/landing/product-details.html"> <img class="border border-translucent rounded" src="{{ url('img/products/10.png') }}" width="53" alt="" /></a>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        ...
                        </button><img class="img-fluid" src="{{ url('img/products/1.png') }}" alt="" />
                        </div><a class="stretched-link" href="../../../apps/e-commerce/landing/product-details.html">
                        <h6 class="mb-2 lh-sm line-clamp-3 product-name">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends Carbon/Graphite, One Size (S &amp; L Bands)</h6>
                        </a>
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/3.png') }}" alt="" />
                        </div><a class="stretched-link" href="../../../apps/e-commerce/landing/product-details.html">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/2.png') }}" alt="" /><span class="badge text-bg-success fs-10 product-verified-badge">Verified<span class="fas fa-check ms-1"></span></span>
                        </div><a class="stretched-link" href="../../../apps/e-commerce/landing/product-details.html">
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        ...
                        <p class="fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="text-body-quaternary fw-semibold ms-1">(6 people rated)</span>
                        </p>
                    </div>
                    <div>
                ...
                <div class="position-relative text-decoration-none product-card h-100">
                    ...
                    <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                        <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span class="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span class="far fa-heart d-none-hover" data-fa-transform="down-1"></span>
                        </button><img class="img-fluid" src="{{ url('img/products/6.png') }}" alt="" />
                        </div><a class="stretched-link" href="../../../apps/e-commerce/landing/product-details.html">
