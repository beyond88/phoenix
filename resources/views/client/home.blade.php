            ...
            <div class="container px-xl-0 px-xxl-3">
                <div class="row g-3 mb-9">
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-n1 product-bg" style="background-image:url('{{ url('img/e-commerce/whooping_banner_product.png') }}');background-position: bottom right;">
                            </div>
                            <!--/.bg-holder-->

                            <div class="bg-holder z-n1 shape-bg" style="background-image:url('{{ url('img/e-commerce/whooping_banner_shape_2.png') }}');background-position: bottom left;">
                            </div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-n1 banner-bg" style="background-image:url('{{ url('img/e-commerce/gift-items-banner-bg.png') }}');">
                            </div>
                            <!--/.bg-holder-->
                            ...
                            <div class="banner-text text-md-center">
                                ...
                                <a class="btn btn-lg btn-primary rounded-pill banner-button" href="#!">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-3 overflow-hidden">
                            <div class="bg-holder z-n1 banner-bg" style="background-image:url('{{ url('img/e-commerce/best-in-market-bg.png') }}');">
                            </div>
                            <!--/.bg-holder-->
                            ...
                            <div class="row align-items-center w-sm-100">
                                <div class="col-8">
                                    <div class="banner-text">
                                        ...
                                        <a class="btn btn-lg btn-warning rounded-pill banner-button" href="#!">Buy Now</a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <!-- Dynamic Image Source -->
                                    <img class="w-100 w-sm-75" src="{{ url('img/e-commerce/5.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-9 col-xxl-10">
                    <div class="d-flex flex-between-center mb-3">
                        ...
                        <a class="btn btn-link btn-lg p-0 d-none d-md-block" href="#!">
                ...
                <div class="col-lg-3 d-none d-lg-block col-xxl-2">
                    <div class="h-100 position-relative rounded-3 overflow-hidden">
                        <div class="bg-holder" style="background-image:url('{{ url('img/e-commerce/4.png') }}');">
                        </div>
                        <!--/.bg-holder-->
                    </div>
                </div>
                ...
                <div class="col-12 d-lg-none">
                    <a href="#!">
                        <img class="w-100 rounded-3" src="{{ url('img/e-commerce/6.png') }}" alt="" />
                    </a>
                </div>
                ...
                <div class="mb-6">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <p class="fs-9">
                                                    ...
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="text-body-quaternary fw-semibold ms-1">(13 people rated)</span>
                                                </p>
                                            </div>
                                            <div>
                                                <h3 class="text-body-emphasis">$799.00</h3>
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <p class="fs-9">
                                                    ...
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="text-body-quaternary fw-semibold ms-1">(64 people rated)</span>
                                                </p>
                                            </div>
                                            <div>
                                                <p class="fs-9 text-body-highlight fs-9 mb-0 fw-bold">Leather cover add-on available</p>
                                                <p class="fs-9 text-body-tertiary fs-9 mb-2">supports Windows 11</p>
                                                <h3 class="text-body-emphasis">$299.00</h3>
                                                <p class="text-body-tertiary fw-semibold fs-9 lh-1 mb-0">1 color</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container active" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove from wishlist">
                                                        <span class="fas fa-heart" data-fa-transform="down-1"></span>
                                                    </button>
                                                ...
                                                <p class="fs-9">
                                                    ...
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="text-body-quaternary fw-semibold ms-1">(32 people rated)</span>
                                                </p>
                                            </div>
                                            <div>
                                                <h3 class="text-body-emphasis">$20.00</h3>
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <p class="fs-9">
                                                    ...
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="fa fa-star text-warning"></span>
                                                    <span class="text-body-quaternary fw-semibold ms-1">(39 people rated)</span>
                                                </p>
                                            </div>
                                            <div>
                                                <p class="fs-9 text-body-highlight fs-9 mb-0 fw-bold">Free with iPhone 5s</p>
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <p class="fs-9">
                                                    ...
                                                    <span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                                                    <span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                                                    <span class="text-body-quaternary fw-semibold ms-1">(6 people rated)</span>
                                                </p>
                                            </div>
                                            <div>
                                                <p class="fs-9 text-body-highlight fs-9 mb-0 fw-bold">Bundle available</p>
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <p class="fs-9">
                                                    ...
                                                    <span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                                                    <span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                                                    <span class="text-body-quaternary fw-semibold ms-1">(7 people rated)</span>
                                                </p>
                                            </div>
                                            <div>
                                                <h3 class="text-body-emphasis">$98.00</h3>
                    ...
                    <a class="fw-bold d-md-none" href="#!">
                        Explore more<span class="fas fa-chevron-right fs-9 ms-1"></span>
                    </a>
                </div>
                <div class="mb-6">
                    <div class="d-flex flex-between-center mb-3">
                        <h3>Best Offers</h3>
                        <a class="fw-bold d-none d-md-block" href="#!">
                            Explore more<span class="fas fa-chevron-right fs-9 ms-1"></span>
                        </a>
                    </div>
                    <div class="swiper-theme-container products-slider">
                ...
                <div class="row flex-center mb-15 mt-11 gy-6">
                    <div class="col-auto">
                        <!-- Dynamic Image URL -->
                        <img class="d-dark-none" src="{{ url('img/spot-illustrations/light_30.png') }}" alt="" width="305" />
                        <img class="d-light-none" src="{{ url('img/spot-illustrations/dark_30.png') }}" alt="" width="305" />
                    </div>
                    <div class="col-auto">
                        <div class="text-center text-lg-start">
                            ...
                            <h1 class="display-3 fw-semibold mb-4">Become a <span class="text-primary fw-bolder">member </span>today!</h1>
                            <a class="btn btn-lg btn-primary px-7" href="{{ url('pages/authentication/simple/sign-up.html') }}">Sign up<span class="fas fa-chevron-right ms-2 fs-9"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                        ...
                        <div class="text-center mt-auto">
                            <div class="avatar avatar-3xl status-online">
                                <!-- Dynamic Image URL -->
                                <img class="rounded-circle border border-3 border-light-subtle" src="{{ url('img/team/30.webp') }}" alt="" />
                            </div>
