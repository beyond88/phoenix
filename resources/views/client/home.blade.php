            ...
            <div class="container-small">
                <div class="scrollbar">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="icon-nav-item" href="#!">
                            <div class="icon-container mb-2" data-bs-theme="undefined">
                ...
                <div class="row flex-center mb-15 mt-11 gy-6">
                    ...
                    <div class="col-auto">
                        <div class="text-center text-lg-start">
                            ...
                            <a class="btn btn-lg btn-primary px-7" href="{{ url('register') }}">Sign up<span class="fas fa-chevron-right ms-2 fs-9"></span></a>
                        </div>
                    </div>
                </div>
            </div>
