<form class="mb-9">
    ...
    <script>
        ...
        wp.passwordStrength = {
            ...
            userInputDisallowedList : function() {
                var i, userInputFieldsLength, rawValuesLength, currentField,
                    rawValues       = [],
                    disallowedList  = [],
                    userInputFields = [ 'username', 'first_name', 'last_name', 'email', 'url' ];
                ...
                for ( i = 0; i < userInputFieldsLength; i++ ) {
                    currentField = document.getElementById(userInputFields[i]);

                    if ( !currentField ) {
                        continue;
                    }

                    rawValues.push(currentField.defaultValue);
                ...
                disallowedList = disallowedList.filter((value, index, self) => {
        ...
        function check_pass_strength() {
            ...
            console.log('current pass==>',pass1);
            console.log('current userInputDisallowedList==>',wp.passwordStrength.userInputDisallowedList());
            console.log('again pass==>',pass1);
            console.log('current strenght==>',strength);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pass1) {
                ...
                pass1.addEventListener('pwupdate', function(e) {
                    //console.log('PWUpdate event triggered');
                    //check_pass_strength();
                });
                //check_pass_strength();
