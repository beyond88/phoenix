            ...
            <div data-list='{"valueNames":["product","customer","rating","review","time"],"page":6}'>
                ...
                <table class="table fs-9 mb-0 border-top border-translucent">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/1.png') }}" alt="" width="53" /></a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/2.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/59.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/3.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/58.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/4.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle avatar-placeholder" src="{{ url('img/team/40x40/avatar.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/5.png') }}" alt="" width="53" /></a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/6.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/57.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/7.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/3.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/8.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/26.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/9.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/29.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/10.png') }}" alt="" width="53" /></a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/11.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/8.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/12.png') }}" alt="" width="53" /></a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/13.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/9.webp') }}" alt="" />
                            </div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/14.png') }}" alt="" width="53" /></a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="{{ url('img//products/60x60/15.png') }}" alt="" width="53" /></a></td>
                        ...
                        <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                            <div class="avatar avatar-l"><img class="rounded-circle" src="{{ url('img/team/40x40/24.webp') }}" alt="" />
                            </div>
                    ...
                    <tbody class="list" id="table-regions-by-revenue">
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">1. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/india.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">2. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/china.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">3. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/usa.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">4. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/south-korea.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">5. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/vietnam.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">6. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/russia.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">7. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/australia.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">8. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/england.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">9. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/indonesia.png') }}" alt="" width="24" />
                        ...
                        <td class="white-space-nowrap ps-0 country" style="width:32%">
                            ...
                            <h6 class="mb-0 me-3">10. </h6><a href="#!">
                                <div class="d-flex align-items-center"><img src="{{ url('img/country/japan.png') }}" alt="" width="24" />
