            ...
            <div id="products" data-list='{"valueNames":["product","price","category","tags","vendor","time"],"page":10,"pagination":true}'>
                ...
                <div class="table-responsive scrollbar mx-n1 px-1">
                    ...
                    <tbody class="list" id="products-table-body">
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/1.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; ...</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/2.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/3.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/4.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU...</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/5.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/6.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">PlayStation 5 DualSense Wireless Controller</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/7.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) - Space Gray</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/8.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Amazon Basics Matte Black Wired Keyboard - US Layout (QWERTY)</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/10.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Apple Magic Mouse (Wireless, Rechargable) - Silver</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/12.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">HORI Racing Wheel Apex for PlayStation 4_3, and PC</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/21.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Apple Pencil (2nd Generation)</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/16.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Apple AirPods (2nd Generation)</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/17.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Xbox Series S</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/18.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Seagate Portable 2TB External Hard Drive Portable HDD</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/19.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">Intel Core i9-11900K Desktop Processor 8 Cores up to 5.3 GHz Unlocked</a></td>
                        ...
                        <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/20.png') }}" alt="" width="53" /></a></td>
                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('admin/products/1') }}">ASUS TUF Gaming F15 Gaming Laptop</a></td>
