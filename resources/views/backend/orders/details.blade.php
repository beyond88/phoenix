...
@section("title", "Order Details | Phoenix")
            ...
            <div class="row g-5 gy-7">
                ...
                <div id="orderTable" data-list='{"valueNames":["products","color","size","price","quantity","total"],"page":10}'>
                    ...
                    <table class="table fs-9 mb-0 border-top border-translucent">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/1.png') }}" alt="" width="53" /></a></td>
                            <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('admin/products/1') }}">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; L Bands)</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/2.png') }}" alt="" width="53" /></a></td>
                            <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('admin/products/1') }}">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/3.png') }}" alt="" width="53" /></a></td>
                            <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('admin/products/1') }}">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                            <td class="color align-middle white-space-nowrap text-body py-0 ps-4">Glossy black</td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/4.png') }}" alt="" width="53" /></a></td>
                            <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('admin/products/1') }}">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU, 7 Core GPU, 256GB SSD, Green (MJV83ZP/A) 2021</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/5.png') }}" alt="" width="53" /></a></td>
                            <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('admin/products/1') }}">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('admin/products/1') }}"><img src="{{ url('img//products/6.png') }}" alt="" width="53" /></a></td>
                            <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('admin/products/1') }}">PlayStation 5 DualSense Wireless Controller</a></td>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <select class="form-select" aria-label="delivery type">
